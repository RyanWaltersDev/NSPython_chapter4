...
#Producing the same result from the range function in the 
    #earlier square function but with a list comprehension
print("\nProducing the same result from the earlier range function " 
    "with squares, but using a list comprehension:")
sqaures = [value**2 for value in range(1, 11)]
print(squares)

#Using a list comprehension to affect a range of numbers with an equation
print("\nUsing a list comprehension to affect a range of numbers" 
    "with a simple equation:")
numbers = [value+3-1 for value in range(1, 5)]
print(numbers)

#Try it yourself 4-3 counting to twenty
print("\nUsing a for loop and a list function to print a list that counts "
    "to twenty in two different ways:")
twenty_list = []
...
print("\nUsing the third argument of the range() function to list only "
    "odd numbers 1 through 20 with a for loop and a list function:")
twenty_odd_list = []
...
print("\nUsing a for loop and a list function to count the multiples of "
    "3 from 3 to 30:")
threes_list = []
...
print("\nUsing a for loop and list comprehension to print the first "
    "10 cubes in two different ways:")
cubes_list = []

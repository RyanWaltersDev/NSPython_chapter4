...
for animal in animal_list:
	print(f"If you ever come across a {animal.title()} in the wild, be alert! They might try to eat you.")
print("All of these animals are at the top of their respective food chain, and while fascinating, are very dangerous!")
